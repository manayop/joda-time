...
public final class Days extends BaseSingleFieldPeriod {
    ...
    public static final Days ZERO = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,0);
    /** Constant representing one day. */
    public static final Days ONE = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,1);
    /** Constant representing two days. */
    public static final Days TWO = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,2);
    /** Constant representing three days. */
    public static final Days THREE = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,3);
    /** Constant representing four days. */
    public static final Days FOUR = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,4);
    /** Constant representing five days. */
    public static final Days FIVE = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,5);
    /** Constant representing six days. */
    public static final Days SIX = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,6);
    /** Constant representing seven days. */
    public static final Days SEVEN = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,7);
    /** Constant representing the maximum number of days that can be stored in this object. */
    public static final Days MAX_VALUE = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,Integer.MAX_VALUE);
    /** Constant representing the minimum number of days that can be stored in this object. */
    public static final Days MIN_VALUE = (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,Integer.MIN_VALUE);
    ...
    public static Days days(int days) {
        return (Days) BaseSingleFieldPeriodPool.retrieve(Days.class,days);
    }
