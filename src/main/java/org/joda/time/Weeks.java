...
public final class Weeks extends BaseSingleFieldPeriod {
    ...
    public static final Weeks ZERO = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,0);
    /** Constant representing one week. */
    public static final Weeks ONE = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,1);
    /** Constant representing two weeks. */
    public static final Weeks TWO = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,2);
    /** Constant representing three weeks. */
    public static final Weeks THREE = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,3);
    /** Constant representing the maximum number of weeks that can be stored in this object. */
    public static final Weeks MAX_VALUE = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,Integer.MAX_VALUE);
    /** Constant representing the minimum number of weeks that can be stored in this object. */
    public static final Weeks MIN_VALUE = (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,Integer.MIN_VALUE);
    ...
    public static Weeks weeks(int weeks) {
        return (Weeks) BaseSingleFieldPeriodPool.retrieve(Weeks.class,weeks);
    }
