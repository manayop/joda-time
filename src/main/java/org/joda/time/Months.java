...
public final class Months extends BaseSingleFieldPeriod {
    ...
    public static final Months ZERO = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,0);
    /** Constant representing one month. */
    public static final Months ONE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,1);
    /** Constant representing two months. */
    public static final Months TWO = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,2);
    /** Constant representing three months. */
    public static final Months THREE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,3);
    /** Constant representing four months. */
    public static final Months FOUR = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,4);
    /** Constant representing five months. */
    public static final Months FIVE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,5);
    /** Constant representing six months. */
    public static final Months SIX = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,6);
    /** Constant representing seven months. */
    public static final Months SEVEN = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,7);
    /** Constant representing eight months. */
    public static final Months EIGHT = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,8);
    /** Constant representing nine months. */
    public static final Months NINE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,9);
    /** Constant representing ten months. */
    public static final Months TEN = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,10);
    /** Constant representing eleven months. */
    public static final Months ELEVEN = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,11);
    /** Constant representing twelve months. */
    public static final Months TWELVE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,12);
    /** Constant representing the maximum number of months that can be stored in this object. */
    public static final Months MAX_VALUE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,Integer.MAX_VALUE);
    /** Constant representing the minimum number of months that can be stored in this object. */
    public static final Months MIN_VALUE = (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,Integer.MIN_VALUE);
    ...
    public static Months months(int months) {
        return (Months) BaseSingleFieldPeriodPool.retrieve(Months.class,months);
    }
