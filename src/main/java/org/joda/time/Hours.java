...
public final class Hours extends BaseSingleFieldPeriod {
    ...
    public static final Hours ZERO = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,0);
    /** Constant representing one hour. */
    public static final Hours ONE = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,1);
    /** Constant representing two hours. */
    public static final Hours TWO = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,2);
    /** Constant representing three hours. */
    public static final Hours THREE = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,3);
    /** Constant representing four hours. */
    public static final Hours FOUR = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,4);
    /** Constant representing five hours. */
    public static final Hours FIVE = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,5);
    /** Constant representing six hours. */
    public static final Hours SIX = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,6);
    /** Constant representing seven hours. */
    public static final Hours SEVEN = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,7);
    /** Constant representing eight hours. */
    public static final Hours EIGHT = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,8);
    /** Constant representing the maximum number of hours that can be stored in this object. */
    public static final Hours MAX_VALUE = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,Integer.MAX_VALUE);
    /** Constant representing the minimum number of hours that can be stored in this object. */
    public static final Hours MIN_VALUE = (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,Integer.MIN_VALUE);
    ...
    public static Hours hours(int hours) {
        return (Hours) BaseSingleFieldPeriodPool.retrieve(Hours.class,hours);
    }
